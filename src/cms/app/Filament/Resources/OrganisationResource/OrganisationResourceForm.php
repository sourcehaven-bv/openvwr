...
class OrganisationResourceForm
{
    ...
    private static function prefixSection(): Section
    {
        return Section::make()
    ...
    /**
     * Details the AP asks for in every data breach notification, so they belong
     * to the organisation rather than to a single breach.
     */
    private static function apSection(): Section
    {
        return Section::make()
