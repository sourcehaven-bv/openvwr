...
- **{{ __('avg_responsible_processing_record_service.model_singular') }}**: {!! Str::toSingleLineEscapedString($record->avgResponsibleProcessingRecordService?->name) !!}
...
- **{{ __('avg_responsible_processing_record.responsibility_distribution') }}**: {!! Str::toSingleLineEscapedString($record->responsibility_distribution, '-') !!}
...
- **{{ __('general.description') }}**: {!! Str::toSingleLineEscapedString($stakeholder->description, '-') !!}
  - **{{ __('stakeholder.special_collected_data') }}**
    ...
    - **{{ __('stakeholder.special_collected_data_explanation') }}**: {!! Str::toSingleLineEscapedString($stakeholder->special_collected_data_explanation, '-') !!}
...
- **{{ __('avg_responsible_processing_record.logic') }}**: {!! Str::toSingleLineEscapedString($record->logic, '-') !!}
- **{{ __('avg_responsible_processing_record.importance_consequences') }}**: {!! Str::toSingleLineEscapedString($record->importance_consequences, '-') !!}

## {{ __('avg_responsible_processing_record.step_system') }}

<!--- #App\Models\System# --->

- **{{ __('avg_responsible_processing_record.has_algorithms') }}**: {{ $record->has_algorithms ? 'ja' : 'nee' }}
...
- **{{ __('avg_responsible_processing_record.has_pseudonymization') }}**: {{ $record->has_pseudonymization ? 'ja' : 'nee' }}
  - **{{ __('avg_responsible_processing_record.pseudonymization') }}**: {!! Str::toSingleLineEscapedString($record->pseudonymization, '-') !!}
...
- **{{ __('avg_responsible_processing_record.outside_eu_protection_level_description') }}**: {!! Str::toSingleLineEscapedString($record->outside_eu_protection_level_description, '-') !!}
- **{{ __('avg_responsible_processing_record.outside_eu_description') }}**: {!! Str::toSingleLineEscapedString($record->outside_eu_description, '-') !!}
