...
return [
    ...
    'tasks_heading' => 'Wat wilt u doen?',
    'tasks_intro' => 'Kies de taak die u voor u heeft. Elke taak is kort en verwijst voor de '
        . 'uitleg door naar de naslag, zodat de beschrijving van een scherm maar op één plek staat.',

    'reference_heading' => 'Naslag',
    'reference_intro' => 'De volledige uitleg, één keer opgeschreven. De taken hierboven '
        . 'verwijzen hiernaar.',

    'overview_heading' => 'Alle onderwerpen',
    'overview_intro' => 'Alles wat in deze handleiding staat, in één overzicht.',

    'search_placeholder' => 'Zoek in taken en naslag…',
    'search_results' => ':tasks taken en :topics onderwerpen gevonden.',
