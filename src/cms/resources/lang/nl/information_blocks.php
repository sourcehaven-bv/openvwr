...
return [
    ...
    'algorithm_record' => [
        ...
        'step_responsible_use_info' => '
            <p class="text-sm text-gray-500">Beschrijf bij "Doel en impact" het doel van het algoritme, het probleem dat ermee wordt opgelost en de verwachte voordelen. Bij "Afwegingen" noteer je de ethische overwegingen en afwegingen bij de ontwikkeling. Geef bij "Menselijke tussenkomst" aan hoe en wanneer menselijke tussenkomst plaatsvindt en licht de risicobeheersmaatregelen toe bij "Risicobeheer". Vul bij "Titel van wettelijke basis" de naam van de wettelijke grondslag in, beschrijf deze bij "Wettelijke basis" en plaats een "Link naar wettelijke basis". Verwijs bij "Link naar verwerkingsregister" naar het openbare deel van het verwerkingsregister. Beschrijf bij "Impacttoetsen" welke toetsen zijn uitgevoerd (zoals een DPIA of IAMA), voeg "Links naar impacttoetsen" toe en licht bij "Toelichting op impacttoetsen" toe waarom bepaalde toetsen wel of niet zijn uitgevoerd.</p>',

        'step_mechanics_title' => 'Informatie over Werking',
        'step_mechanics_info' => '
            <p class="text-sm text-gray-500">Vul bij "Titel van gegevensbron" de naam van de gebruikte gegevensbron in. Beschrijf bij "Gegevens" welke data door het algoritme wordt gebruikt. Voeg bij "Links naar gegevensbronnen" de relevante bronnen toe. Leg bij "Technische werking" uit hoe het algoritme functioneert en welke technieken het gebruikt. Vermeld bij "Leverancier" de externe leverancier van het algoritme, of "Intern ontwikkeld" wanneer de organisatie het zelf heeft gebouwd. Voeg bij "Link naar broncode" een link toe naar de broncode van het algoritme, indien beschikbaar.</p>',
