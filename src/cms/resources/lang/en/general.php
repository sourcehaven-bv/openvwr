...
return [
    ...
    'force_delete_confirm_title' => 'Delete permanently?',
    'force_delete_confirm_description' => 'This irreversibly removes the item and its associated files. This action cannot be undone.',
    'force_delete_confirm_submit' => 'Yes, delete permanently',
    'disabled' => 'Disabled',
    'download' => 'Download',
    'enabled' => 'Enabled',
    'error' => 'Error',
