...
| 20d2 | Upload `05-verwerkingen-met-verwerkers.csv` terwijl "Importeren als" nog op Datalekken staat. Controleer dat de inleiding "te importeren als Datalekken" meldt en vrijwel niets gekoppeld is. Kies bovenaan het register AVG Verantwoordelijke Verwerkingen en controleer dat de mapping opnieuw is voorgesteld, nu met Naam verwerking, Verwerkers en Systemen ingevuld. | [ ]           |             |
...
| 51a | Voeg in Excel aan `05-verwerkingen-met-verwerkers.csv` twee kolommen toe, "Tekst" en "Afdeling", met wat vrije tekst, en laat één cel leeg. Koppel beide aan "Notitie" (groep Notities) en importeer. Controleer dat elke verwerking per gevulde cel een opmerking heeft: uit "Tekst" de tekst zelf (een notitiekolom), uit "Afdeling" in de vorm "Afdeling: …", en dat een lege cel geen opmerking geeft. | [ ]           |             |
...
| 62  | Koppel Id aan Bronkenmerk, Naam aan Naam verwerking, Dienst aan Dienst, Tekst aan Notitie, Systeem aan Systemen, Doel aan AVG doelen, Contactpersoon aan Overige contactpersonen en E-mail contactpersoon aan "Overige contactpersonen — E-mailadres". Klik "Proefdraaien" en controleer: 2 passen, 0 aandacht. | [ ]           |             |
| 63  | Importeer en open "Salarisadministratie". Controleer: twee systemen (Salarispakket, HR-systeem), één doel, één contactpersoon P. de Vries met e-mailadres, één opmerking "Overgenomen uit het oude register". "Toegangsbeheer" heeft één systeem en één doel. | [ ]           |             |
