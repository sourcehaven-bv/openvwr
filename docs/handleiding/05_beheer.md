...
![Gebruikers beheer\label{fig:gebruikers_beheer}](./imgs/05_beheer/01_users_edit.png)
...
![Een bewaartermijn kiezen\label{fig:bewaartermijn_kiezen}](./imgs/05_beheer/02_retention_period_select.png)
...
![Een eigen bewaartermijn invullen\label{fig:bewaartermijn_overig}](./imgs/05_beheer/03_retention_period_other.png)
